...
void RaceManager::mainRun()
{
	    ...
	    cout<<"The prompts will guid you as you go ahead."<<endl;
	    cout<<"Shall we start? Type 'Y' or 'N' "<<endl;
	    cin>>start;
	if(start == "Y" || start == "y"){
		...
		cout<<"Simulation ended. Have a Nice day!"<<endl;    
	}
    //return 0;
}
